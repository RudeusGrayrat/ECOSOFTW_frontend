...
var classes = {
  ...
  menuitem: function menuitem(_ref2) {
    var active = _ref2.active, disabled = _ref2.disabled, item = _ref2.item;
...
var Steps = React.memo(React.forwardRef(function(inProps, ref) {
  ...
  var _StepsBase$setMetaDat = StepsBase.setMetaData(_objectSpread({}, metaData)), ptm = _StepsBase$setMetaDat.ptm, ptmo = _StepsBase$setMetaDat.ptmo, cx = _StepsBase$setMetaDat.cx, isUnstyled = _StepsBase$setMetaDat.isUnstyled;
  ...
  var onItemKeyDown = function onItemKeyDown2(event, item, index) {
    if (props.readOnly) {
      return;
    }
    switch (event.code) {
  ...
  var setFocusToFirstItem = function setFocusToFirstItem2() {
    var firstItem = findFirstItem();
  ...
  var createItem = function createItem2(item, index) {
    ...
    var icon2 = IconUtils.getJSXIcon(item.icon, _objectSpread({}, iconProps), {
      props
    });
    ...
    var content = React.createElement("a", actionProps, React.createElement("span", stepProps, index + 1), icon2, label);
    if (item.template) {
  ...
  var createItems = function createItems2() {
    ...
    if (props.model) {
      ...
      return React.createElement("ol", menuProps, _items);
    }
    return null;
  };
  ...
  return React.createElement("nav", rootProps, items);
}));
